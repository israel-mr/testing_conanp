...
ambientes <- data.frame(
  ...
  Superficie = c(23066607, 70794424),
  Porcentaje_ANP = c(24.58, 75.42),
  Porcentaje_Territorio = c(11.72, 22.47)
)
...
ambientes$hover_text <- paste(c(
            paste0(notas_terrestres,
                   ...
                   "<b>",ambientes$Porcentaje_ANP[1],"</b>", "%",
                    "<br>&nbsp;&nbsp;<b>188 ANP</b> cuentan con superficie exclusivamente terrestre.</b>"
